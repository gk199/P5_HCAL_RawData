...
void process_events_QIEscan_LED60() {
  ...
  chain->Add("/afs/cern.ch/work/g/gkopp/MWGR/CMSSW_12_0_0/src/HCALPFG/HcalTupleMaker/test/outputFile_run347751_full.root",0);
