...
// Tue Feb 22 19:27:53 2022 by ROOT version 6.22/09
// from TTree tree/
// found on file: /afs/cern.ch/work/g/gkopp/MWGR/CMSSW_12_0_0/src/HCALPFG/HcalTupleMaker/test/outputFile_run347746_full.root
//////////////////////////////////////////////////////////

#ifndef HcalPfgStudies_QIEscan_h
#define HcalPfgStudies_QIEscan_h
...
// Fixed size dimensions of array or collections stored in the TTree if any.
   ...
   HcalPfgStudies_QIEscan(TTree *tree=0);
   virtual ~HcalPfgStudies_QIEscan();
...
#ifdef HcalPfgStudies_QIEscan_cxx
HcalPfgStudies_QIEscan::HcalPfgStudies_QIEscan(TTree *tree) : fChain(0) 
{
// if parameter tree is not specified (or zero), connect the file
// used to generate this class and read the Tree.
   if (tree == 0) {
      TFile *f = (TFile*)gROOT->GetListOfFiles()->FindObject("/afs/cern.ch/work/g/gkopp/MWGR/CMSSW_12_0_0/src/HCALPFG/HcalTupleMaker/test/outputFile_run347746_full.root");
      if (!f || !f->IsOpen()) {
         f = new TFile("/afs/cern.ch/work/g/gkopp/MWGR/CMSSW_12_0_0/src/HCALPFG/HcalTupleMaker/test/outputFile_run347746_full.root");
      }
      TDirectory * dir = (TDirectory*)f->Get("/afs/cern.ch/work/g/gkopp/MWGR/CMSSW_12_0_0/src/HCALPFG/HcalTupleMaker/test/outputFile_run347746_full.root:/hcalTupleTree");
...
HcalPfgStudies_QIEscan::~HcalPfgStudies_QIEscan()
{
   if (!fChain) return;
   delete fChain->GetCurrentFile();
}

Int_t HcalPfgStudies_QIEscan::GetEntry(Long64_t entry)
{
// Read contents of entry.
   if (!fChain) return 0;
   return fChain->GetEntry(entry);
}
Long64_t HcalPfgStudies_QIEscan::LoadTree(Long64_t entry)
{
...
void HcalPfgStudies_QIEscan::Init(TTree *tree)
{
...
Bool_t HcalPfgStudies_QIEscan::Notify()
{
...
void HcalPfgStudies_QIEscan::Show(Long64_t entry)
{
...
Int_t HcalPfgStudies_QIEscan::Cut(Long64_t entry)
{
...
#endif // #ifdef HcalPfgStudies_QIEscan_cxx
