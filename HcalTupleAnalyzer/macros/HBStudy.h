...
#ifdef HBStudy_cxx
HBStudy::HBStudy(TTree *tree) : fChain(0) 
{
...
Int_t HBStudy::GetEntry(Long64_t entry)
{
// Read contents of entry.
   if (!fChain) return 0;
   return fChain->GetEntry(entry);
}
Long64_t HBStudy::LoadTree(Long64_t entry)
{
...
void HBStudy::Show(Long64_t entry)
{
...
Int_t HBStudy::Cut(Long64_t entry)
{
