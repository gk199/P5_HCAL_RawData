...
//by  b_branchname->GetEntry(ientry); //read only this branch
   ...
   if (TEfficiency::CheckConsistency(*HB_tdc3_adc64,*HB_adc64)) {
     ...
     effHB->GetPaintedGraph()->SetMinimum(0.9);
     gPad->Update();
   }
   ...
   if (TEfficiency::CheckConsistency(*HB_tdc0_adc64,*HB_adc64)) {
     ...
     if (TEfficiency::CheckConsistency(*HB_tdc0_adc64_soim1,*HB_adc64)) {
       TEfficiency *effHB_m1 = new TEfficiency(*HB_tdc0_adc64_soim1,*HB_adc64);
       effHB_m1->SetLineColor(kGreen);
       effHB_m1->Draw("SAME");
       gPad->Update();
       cHB_adc->SaveAs("2022_plots/HB_TDCprompt_2022_900gev_adc64_soim1.png");
     }
     if (TEfficiency::CheckConsistency(*HB_tdc0_adc64_soip1,*HB_adc64)) {
       TEfficiency *effHB_p1 = new TEfficiency(*HB_tdc0_adc64_soip1,*HB_adc64);
       effHB_p1->SetLineColor(kBlue);
       effHB_p1->Draw("SAME");
       gPad->Update();
       cHB_adc->SaveAs("2022_plots/HB_TDCprompt_2022_900gev_adc64_soim1p1.png");
     }
   }
