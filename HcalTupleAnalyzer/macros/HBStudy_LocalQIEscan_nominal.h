...
#ifndef HBStudy_LocalQIEscan_nominal_h
#define HBStudy_LocalQIEscan_nominal_h
...
class HBStudy_LocalQIEscan_nominal {
public :
...
// Fixed size dimensions of array or collections stored in the TTree if any.
   ...
   HBStudy_LocalQIEscan_nominal(TTree *tree=0);
   virtual ~HBStudy_LocalQIEscan_nominal();
...
#ifdef HBStudy_LocalQIEscan_nominal_cxx
HBStudy_LocalQIEscan_nominal::HBStudy_LocalQIEscan_nominal(TTree *tree) : fChain(0) 
{
// if parameter tree is not specified (or zero), connect the file
// used to generate this class and read the Tree.
   if (tree == 0) {
      TFile *f = (TFile*)gROOT->GetListOfFiles()->FindObject("/eos/user/g/gkopp/QIEscans/HcalTupleMaker_QIE11_TP_13TeV_QIEphasescan_relNominal_run356815_1.root");
      if (!f || !f->IsOpen()) {
         f = new TFile("/eos/user/g/gkopp/QIEscans/HcalTupleMaker_QIE11_TP_13TeV_QIEphasescan_relNominal_run356815_1.root");
      }
      TDirectory * dir = (TDirectory*)f->Get("/eos/user/g/gkopp/QIEscans/HcalTupleMaker_QIE11_TP_13TeV_QIEphasescan_relNominal_run356815_1.root:/hcalTupleTree");
...
HBStudy_LocalQIEscan_nominal::~HBStudy_LocalQIEscan_nominal()
{
   if (!fChain) return;
   delete fChain->GetCurrentFile();
}

Int_t HBStudy_LocalQIEscan_nominal::GetEntry(Long64_t entry)
{
// Read contents of entry.
   if (!fChain) return 0;
   return fChain->GetEntry(entry);
}
Long64_t HBStudy_LocalQIEscan_nominal::LoadTree(Long64_t entry)
{
...
void HBStudy_LocalQIEscan_nominal::Init(TTree *tree)
{
...
Bool_t HBStudy_LocalQIEscan_nominal::Notify()
{
...
void HBStudy_LocalQIEscan_nominal::Show(Long64_t entry)
{
...
Int_t HBStudy_LocalQIEscan_nominal::Cut(Long64_t entry)
{
...
#endif // #ifdef HBStudy_LocalQIEscan_nominal_cxx
