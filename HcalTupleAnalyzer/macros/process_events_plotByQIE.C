...
void process_events_plotByQIE() {
  ...
  //  chain->Add("file:/eos/user/g/gkopp/QIEscans/HcalTupleMaker_Local_run360094_initialTDCLUTs.root",0); // reference before LUTs changed, 11 Oct
  //  chain->Add("file:/eos/user/g/gkopp/QIEscans/HcalTupleMaker_Local_run360234_updatedTDCLUTs.root",0); // run when LUTs were changed, 12 Oct
