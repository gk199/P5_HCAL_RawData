...
// Thu Jul 14 12:33:19 2022 by ROOT version 6.24/06
// from TTree tree/
// found on file: /eos/user/g/gkopp/QIEscans/HcalTupleMaker_QIE11_TP_900GeV_nominalPhases_run352417.root
//////////////////////////////////////////////////////////

#ifndef HBStudy_QIE_TP_h
#define HBStudy_QIE_TP_h
...
// Fixed size dimensions of array or collections stored in the TTree if any.
   ...
   vector<int>     *HcalTriggerPrimitiveFineGrainSOI0;
   vector<int>     *HcalTriggerPrimitiveFineGrainSOI1;
   vector<int>     *HcalTriggerPrimitiveFineGrainSOI2;
   vector<int>     *HcalTriggerPrimitiveFineGrainSOI3;
   vector<int>     *HcalTriggerPrimitiveFineGrainSOI4;
   vector<int>     *HcalTriggerPrimitiveFineGrainSOI5;
   ...
   vector<vector<int> > *HcalTriggerPrimitiveFineGrain0;
   vector<vector<int> > *HcalTriggerPrimitiveFineGrain1;
   vector<vector<int> > *HcalTriggerPrimitiveFineGrain2;
   vector<vector<int> > *HcalTriggerPrimitiveFineGrain3;
   vector<vector<int> > *HcalTriggerPrimitiveFineGrain4;
   vector<vector<int> > *HcalTriggerPrimitiveFineGrain5;
   ...
   HBStudy_QIE_TP(TTree *tree=0);
   virtual ~HBStudy_QIE_TP();
...
#ifdef HBStudy_QIE_TP_cxx
HBStudy_QIE_TP::HBStudy_QIE_TP(TTree *tree) : fChain(0) 
{
// if parameter tree is not specified (or zero), connect the file
// used to generate this class and read the Tree.
   if (tree == 0) {
      TFile *f = (TFile*)gROOT->GetListOfFiles()->FindObject("/eos/user/g/gkopp/QIEscans/HcalTupleMaker_QIE11_TP_900GeV_nominalPhases_run352417.root");
      if (!f || !f->IsOpen()) {
         f = new TFile("/eos/user/g/gkopp/QIEscans/HcalTupleMaker_QIE11_TP_900GeV_nominalPhases_run352417.root");
      }
      TDirectory * dir = (TDirectory*)f->Get("/eos/user/g/gkopp/QIEscans/HcalTupleMaker_QIE11_TP_900GeV_nominalPhases_run352417.root:/hcalTupleTree");
...
HBStudy_QIE_TP::~HBStudy_QIE_TP()
{
   if (!fChain) return;
   delete fChain->GetCurrentFile();
}

Int_t HBStudy_QIE_TP::GetEntry(Long64_t entry)
{
// Read contents of entry.
   if (!fChain) return 0;
   return fChain->GetEntry(entry);
}
Long64_t HBStudy_QIE_TP::LoadTree(Long64_t entry)
{
...
void HBStudy_QIE_TP::Init(TTree *tree)
{
...
void HBStudy_QIE_TP::Show(Long64_t entry)
{
...
Int_t HBStudy_QIE_TP::Cut(Long64_t entry)
{
...
#endif // #ifdef HBStudy_QIE_TP_cxx
