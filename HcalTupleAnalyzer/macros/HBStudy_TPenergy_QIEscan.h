...
#ifndef HBStudy_TPenergy_QIEscan_h
#define HBStudy_TPenergy_QIEscan_h
...
class HBStudy_TPenergy_QIEscan {
public :
...
// Fixed size dimensions of array or collections stored in the TTree if any.
   ...
   HBStudy_TPenergy_QIEscan(TTree *tree=0);
   virtual ~HBStudy_TPenergy_QIEscan();
...
#ifdef HBStudy_TPenergy_QIEscan_cxx
HBStudy_TPenergy_QIEscan::HBStudy_TPenergy_QIEscan(TTree *tree) : fChain(0) 
{
...
HBStudy_TPenergy_QIEscan::~HBStudy_TPenergy_QIEscan()
{
   if (!fChain) return;
   delete fChain->GetCurrentFile();
}

Int_t HBStudy_TPenergy_QIEscan::GetEntry(Long64_t entry)
{
// Read contents of entry.
   if (!fChain) return 0;
   return fChain->GetEntry(entry);
}
Long64_t HBStudy_TPenergy_QIEscan::LoadTree(Long64_t entry)
{
...
void HBStudy_TPenergy_QIEscan::Init(TTree *tree)
{
...
Bool_t HBStudy_TPenergy_QIEscan::Notify()
{
...
void HBStudy_TPenergy_QIEscan::Show(Long64_t entry)
{
...
Int_t HBStudy_TPenergy_QIEscan::Cut(Long64_t entry)
{
...
#endif // #ifdef HBStudy_TPenergy_QIEscan_cxx
