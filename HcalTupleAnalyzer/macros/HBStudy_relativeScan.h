...
#ifndef HBStudy_relativeScan_h
#define HBStudy_relativeScan_h
...
// Fixed size dimensions of array or collections stored in the TTree if any.
   ...
   HBStudy_relativeScan(TTree *tree=0);
   virtual ~HBStudy_relativeScan();
...
#ifdef HBStudy_relativeScan_cxx
HBStudy_relativeScan::HBStudy_relativeScan(TTree *tree) : fChain(0) 
{
...
HBStudy_relativeScan::~HBStudy_relativeScan()
{
   if (!fChain) return;
   delete fChain->GetCurrentFile();
}

Int_t HBStudy_relativeScan::GetEntry(Long64_t entry)
{
// Read contents of entry.
   if (!fChain) return 0;
   return fChain->GetEntry(entry);
}
Long64_t HBStudy_relativeScan::LoadTree(Long64_t entry)
{
...
void HBStudy_relativeScan::Init(TTree *tree)
{
...
Bool_t HBStudy_relativeScan::Notify()
{
...
void HBStudy_relativeScan::Show(Long64_t entry)
{
...
Int_t HBStudy_relativeScan::Cut(Long64_t entry)
{
...
#endif // #ifdef HBStudy_relativeScan_cxx
